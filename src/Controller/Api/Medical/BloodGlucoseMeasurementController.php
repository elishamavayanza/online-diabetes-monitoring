...
class BloodGlucoseMeasurementController extends AbstractController
{
    ...
    #[OA\Parameter(name: 'from', description: 'Date de début (ISO 8601)', in: 'query', required: false, schema: new OA\Schema(type: 'string', format: 'date-time'))]
    #[OA\Parameter(name: 'to', description: 'Date de fin (ISO 8601)', in: 'query', required: false, schema: new OA\Schema(type: 'string', format: 'date-time'))]
    #[OA\Parameter(name: 'limit', description: 'Nombre max de résultats', in: 'query', required: false, schema: new OA\Schema(type: 'integer'))]
