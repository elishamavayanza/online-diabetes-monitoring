...
class AppointmentResponseDTO
{
    public function __construct(
        #[OA\Property(
            type: 'string',
            format: 'uuid',
            example: 'd3b07384-d113-4ec6-a578-832f01f4c74a',
        ...
        #[OA\Property(
            ...
            description: 'Notes cliniques ou administratives'
        )]
        ...
        #[OA\Property(
            ...
            format: 'uuid',
            nullable: true,
            example: '11aa2233-4455-6677-8899-aabbccddeeff',
    ...
    public static function fromEntity(Appointment $appointment): self
    {
        return new self(
            ...
            facilityId: $appointment->getFacility()?->getId()
                ? (string) $appointment->getFacility()->getId()
                : null,
            ...
            createdById: (string) $appointment->getProfessional()?->getId(),
            createdByName: $appointment->getProfessional()?->getFullName()
        );
    }
}
