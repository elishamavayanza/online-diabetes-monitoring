...
class JWTCreatedListener
{
    ...
    private function getPermissionsForRole(array $roles): array
    {
        ...
        if (in_array('ROLE_ADMIN', $roles, true)) {
            return ['DASHBOARD_VIEW', 'ESTABLISHMENT_VIEW', 'DEPARTMENT_VIEW', 'PROFESSIONAL_VIEW', 'MEMBER_VIEW', 'PATIENT_VIEW', 'APPOINTMENT_VIEW', 'ACTIVITY_VIEW', 'SETTINGS_VIEW', 'NOTIFICATION_VIEW', 'MEDICATION_VIEW'];
        }
