...
class JWTCreatedListener
{
    ...
    private function getPermissionsForRole(array $roles): array
    {
        ...
        if (in_array('ROLE_ADMIN', $roles, true)) {
            return ['DASHBOARD_VIEW', 'ESTABLISHMENT_VIEW', 'DEPARTMENT_VIEW', 'PROFESSIONAL_VIEW', 'MEMBER_VIEW', 'PATIENT_VIEW', 'APPOINTMENT_VIEW', 'ACTIVITY_VIEW', 'SETTINGS_VIEW', 'NOTIFICATION_VIEW', 'MEDICATION_VIEW', 'MANAGE_EXTERNAL_FOLLOW'];
        }
        ...
        if (in_array('ROLE_PATIENT', $roles, true)) {
            return ['SUMMARY_VIEW', 'MEASUREMENT_VIEW', 'HEALTH_RECORD_VIEW', 'TREATMENT_VIEW', 'DOSE_VIEW', 'APPOINTMENT_VIEW', 'APPOINTMENT_CREATE', 'MESSAGE_VIEW', 'TEAM_VIEW', 'NOTIFICATION_VIEW', 'NUTRITION_VIEW'];
        }
        return [];
    }
