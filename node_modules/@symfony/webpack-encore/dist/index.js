...
class Encore {
    ...
    enableForkedTypeScriptTypesChecking(forkedTypeScriptTypesCheckOptionsCallback = () => { }) {
        webpackConfig.enableForkedTypeScriptTypesChecking(forkedTypeScriptTypesCheckOptionsCallback);
        return this;
    }
    /**
    ...
    configureRuntimeEnvironment(environment, options = {}) {
        runtimeConfig = parseRuntime(Object.assign({}, yargsParser([environment]), options), process.cwd());
        webpackConfig = new WebpackConfig(runtimeConfig);
        return this;
    }
    /**
