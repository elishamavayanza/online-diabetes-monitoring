...
class WebpackConfig {
    ...
    externals;
    integrityAlgorithms;
    shouldUseSingleRuntimeChunk;
    shouldSplitEntryChunks;
    useVersioning;
    useSourceMaps;
    cleanupOutput;
    usePersistentCache;
    ...
    useVueLoader;
    useTypeScriptLoader;
    useForkedTypeScriptTypeChecking;
    useBabelTypeScriptPreset;
    useWebpackNotifier;
    useHandlebarsLoader;
    useSvelte;
    imageRuleOptions;
    ...
    preactOptions;
    babelOptions;
    babelTypeScriptPresetOptions;
    vueOptions;
    persistentCacheBuildDependencies;
    imageRuleCallback;
    fontRuleCallback;
    postCssLoaderOptionsCallback;
    sassLoaderOptionsCallback;
    lessLoaderOptionsCallback;
    stylusLoaderOptionsCallback;
    babelConfigurationCallback;
    babelPresetEnvOptionsCallback;
    babelReactPresetOptionsCallback;
    cssLoaderConfigurationCallback;
    styleLoaderConfigurationCallback;
    splitChunksConfigurationCallback;
    devServerOptionsConfigurationCallback;
    vueLoaderOptionsCallback;
    tsConfigurationCallback;
    handlebarsConfigurationCallback;
    forkedTypeScriptTypesCheckOptionsCallback;
    friendlyErrorsPluginOptionsCallback;
    manifestPluginOptionsCallback;
    notifierPluginOptionsCallback;
    watchOptionsConfigurationCallback;
    miniCssExtractLoaderConfigurationCallback;
    miniCssExtractPluginConfigurationCallback;
    loaderConfigurationCallbacks;
    cleanOptionsCallback;
    definePluginOptionsCallback;
    minimizerPluginJsOptionsCallback;
    minimizerPluginCssOptionsCallback;
    cssMinimizerExplicitlyConfigured;
    persistentCacheCallback;
    _babelRcFileExists;
    _babelConfigureOptions;
    _configureBabelCalled;
    _configureBabelPresetEnvCalled;
    ...
    configureJsMinimizerPlugin(jsOptionsCallback = () => { }) {
        if (typeof jsOptionsCallback !== 'function') {
            throw new Error('Argument 1 to configureJsMinimizerPlugin() must be a callback function.');
        }
        ...
        for (const optionKey of Object.keys(options)) {
            if (optionKey === 'includeNodeModules') {
                ...
                this.babelOptions['exclude'] = (filePath) => {
                    ...
                    const whitelistedModules = options[optionKey].map((module) => path.join('node_modules', module) + path.sep);
