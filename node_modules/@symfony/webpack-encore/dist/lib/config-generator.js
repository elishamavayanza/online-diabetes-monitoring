...
import cssMinimizerPluginUtil from './plugins/css-minimizer.js';
...
import jsMinimizerPluginUtil from './plugins/js-minimizer.js';
...
class ConfigGenerator {
    ...
    async getWebpackConfig() {
        ...
        const config = {
            ...
            module: {
                rules: await this.buildRulesConfig(),
            },
            plugins: await this.buildPluginsConfig(),
    ...
    /**
     * Validates deferred babel configuration that was previously done
    ...
    async _validateDeferredBabelConfig() {
        ...
        const configureOptions = this.webpackConfig._babelConfigureOptions || {};
    ...
    buildEntryConfig() {
        ...
        if (copyFilesConfigs.length > 0) {
            ...
            fs.writeFileSync(tmpFileObject.name, copyFilesConfigs.reduce((buffer, entry, index) => {
                ...
                let copyFilesLoaderPath = fileURLToPath(import.meta.resolve('./webpack/copy-files-loader.js'));
    ...
    async buildRulesConfig() {
                ...
                oneOf: [
                    {
                        ...
                        use: cssExtractLoaderUtil.prependLoaders(this.webpackConfig, cssLoaderUtil.getLoaders(this.webpackConfig, true)),
                    },
                    {
        ...
        if (this.webpackConfig.imageRuleOptions.enabled) {
            rules.push(generateAssetRuleConfig(/\.(png|jpg|jpeg|gif|ico|svg|webp|avif)$/, this.webpackConfig.imageRuleOptions, this.webpackConfig.imageRuleCallback, 'images'));
        }
        if (this.webpackConfig.fontRuleOptions.enabled) {
            rules.push(generateAssetRuleConfig(/\.(woff|woff2|ttf|eot|otf)$/, this.webpackConfig.fontRuleOptions, this.webpackConfig.fontRuleCallback, 'fonts'));
        }
    ...
    async buildPluginsConfig() {
        ...
        await notifierPluginUtil(plugins, this.webpackConfig);
        await vuePluginUtil(plugins, this.webpackConfig);
    ...
    buildOptimizationConfig() {
        ...
        if (this.webpackConfig.isProduction()) {
            ...
            if (this.webpackConfig.cssMinimizerExplicitlyConfigured) {
                minimizers.push(cssMinimizerPluginUtil(this.webpackConfig));
            }
        ...
        optimization.splitChunks = applyOptionsCallback(this.webpackConfig.splitChunksConfigurationCallback, splitChunks);
        return optimization;
    }
    buildCacheConfig() {
        const cache = {};
    ...
    buildWatchOptionsConfig() {
        ...
        return applyOptionsCallback(this.webpackConfig.watchOptionsConfigurationCallback, watchOptions);
    }
    buildDevServerConfig() {
        ...
        return applyOptionsCallback(this.webpackConfig.devServerOptionsConfigurationCallback, devServerOptions);
    }
}
/**
