...
export default function (plugins, webpackConfig) {
    ...
    const configuredCssFilename = webpackConfig.configuredFilenames.css;
    ...
    plugins.push({
        plugin: new MiniCssExtractPlugin(applyOptionsCallback(webpackConfig.miniCssExtractPluginConfigurationCallback, miniCssPluginOptions)),
