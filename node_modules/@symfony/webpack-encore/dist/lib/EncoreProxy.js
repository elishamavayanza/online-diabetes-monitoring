...
const removedMethods = {
    configureTerserPlugin: 'Encore.configureTerserPlugin() was removed. Use Encore.configureJsMinimizerPlugin() instead (it takes the same callback).',
};
export default {
    createProxy: (Encore) => {
        const EncoreProxy = new Proxy(Encore, {
            get: (target, prop) => {
                ...
                if (typeof targetValue === 'function') {
                    ...
                    return (...parameters) => {
                        try {
                            const res = targetValue.apply(target, parameters);
